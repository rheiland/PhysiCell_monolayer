# Script from Domenic Germano, U. Melbourne
...
def import_all_simulation_data(framework_head):
    ...
    for index in iter_vals:
        if framework_head == 'Artistoo':
            ...
            file_path = os.path.join(f'cell_data_no_inhibition.csv')  # assume PhysiCell
...
axs[0, 0].hist(stacked_sf, bins=np.arange(xlims1[0], xlims1[1], xdel), stacked=True, label=labels, edgecolor='none', color=cmap(np.linspace(0, 1, len(labels))), density=False)
...
axs[1, 0].hist(stacked_af, bins=np.arange(xlims2[0], xlims2[1], xdel), stacked=True, label=labels, edgecolor='none', color=cmap(np.linspace(0, 1, len(labels))), density=False)
...
axs[0, 1].hist(stacked_sf, bins=np.arange(xlims1[0], xlims1[1], xdel), stacked=True, label=labels, edgecolor='none', color=cmap(np.linspace(0, 1, len(labels))), density=False, cumulative=True)
...
axs[1, 1].hist(stacked_af, bins=np.arange(xlims2[0], xlims2[1], xdel), stacked=True, label=labels, edgecolor='none', color=cmap(np.linspace(0, 1, len(labels))), density=False, cumulative=True)
...
plt.suptitle(f'{framework_head}: single sim, xdel={xdel}', fontweight='bold')
plt.tight_layout()
plt.show()
...
file_path = os.path.join(f'cell_data_no_inhibition.csv')
data = np.loadtxt(file_path, delimiter=',', skiprows=1)
# data = np.loadtxt(file_path, delimiter='\t', skiprows=1)
x_vals = data[:, 0] - x_0
...
for iter, framework_head in enumerate(framework_heads):
    ...
    axs[iter, 0].hist(stacked_sf, bins=np.arange(xlims1[0], xlims1[1], xdel), stacked=True, label=labels, edgecolor='none', color=cmap(np.linspace(0, 1, len(labels))), density=False)
    if iter == 0:
    ...
    axs[iter, 1].hist(stacked_sf, bins=np.arange(xlims1[0], xlims1[1], xdel), stacked=True, label=labels, edgecolor='none', color=cmap(np.linspace(0, 1, len(labels))), density=False, cumulative=True)
    if iter == len(framework_heads)-1:
    ...
    axs[iter, 2].hist(stacked_af, bins=np.arange(xlims2[0], xlims2[1], xdel), stacked=True, label=labels, edgecolor='none', color=cmap(np.linspace(0, 1, len(labels))), density=False)
    if iter == 0:
    ...
    axs[iter, 3].hist(stacked_af, bins=np.arange(xlims2[0], xlims2[1], xdel), stacked=True, label=labels, edgecolor='none', color=cmap(np.linspace(0, 1, len(labels))), density=False, cumulative=True)
