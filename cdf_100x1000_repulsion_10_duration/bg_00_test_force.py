...
#   print(usage_str)
  print("e.g.:  python bg_00_test_force.py ../project_1000_test_force <repulsion force> <cycle_duration>")
  exit(1)
else:
   exec_pgm = sys.argv[1]
#    repulsion = float(sys.argv[2])
   ...
   cycle_duration = sys.argv[3]
   print("--- using duration= ",cycle_duration)
...
# for beta in [0.2]:
    ...
    for gamma in [0.0]:
        ...
        try:
            ...
            xml_root.find('.//' + 'cycle_duration').text = str(cycle_duration)
        except:
