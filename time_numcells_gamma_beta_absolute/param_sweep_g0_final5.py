...
beta_final5 = [0.663, 0.925, 0.9889, 0.9976, 0.9992]
print("beta_final5=",beta_final5)
...
for gamma in [0.0]:
    # for beta in beta_final5:
    for beta, save_interval in zip(beta_final5, save_intervals):
