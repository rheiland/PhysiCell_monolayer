...
plt.show()  # if I don't show the plot here, it seems to be smeared across the 2nd plot!
...
# latest:  0, 95, 99, 99.9, 99.95 (same percentiles for beta and gamma)
#          0, 95, 99, 99.9, 99.95
if cell_scalar_name == "f_i":   # surface fraction; gamma
    ...
    # p5 = np.percentile(all_vals, 99.99)
...
plt.ylabel("CDF (100 runs of 1000 cells)")
# plt.legend()
plt.xlim(right=1.0)
# plt.xlim(left=0.0, right=1.0)
# plt.xlim(left=0.0)
